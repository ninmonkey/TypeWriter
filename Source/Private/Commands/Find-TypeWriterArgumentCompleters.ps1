...
function Find-TypeWriterArgumentCompleters {

    <#
    .SYNOPSIS
        searches for others -- Get custom argument completers registered in the current session.
    .DESCRIPTION
    ...
    #>
    [Alias(
        'TypeWriter.Find-ArgumentCompleter',
        'indented.Get-ArgumentCompleter'
    )]
